return function(Config, Utilities)
    ...
    local ESPObject = loadstring(game:HttpGet("https://raw.githubusercontent.com/None7464/testss/refs/heads/main/skibidi/ESP/ESPObject.lua"))()(Config, Utilities, ESPConfig)
    local ESPManager = loadstring(game:HttpGet("https://raw.githubusercontent.com/None7464/testss/main/skibidi/ESP/ESPManager.lua"))()(Config, Utilities, ESPObject, ESPConfig)
